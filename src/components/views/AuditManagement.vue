<template>
  <section class="content" id="auditmanagementPANE">
       ...
       <ul class="timeline">
        <li>
          ...
          <div class="col-md-12 order-md-3">
            <template>
              <div class="table-responsive" id="auditmanagementTablePANE" style="border:1px solid lightgray">
                <table
                  class="table table-bordered"
                  id="auditDataEditTablePANEID" v-show="submitCategoryNameTXT == 'Data Edit'"
                >
...
export default {
  ...
  mounted () {
    ...
    document.getElementById("auditmanagementPANE").style.height = innerMinHeight;
    document.getElementById("auditmanagementTablePANE").style.height = window.innerHeight - 286 + "px";
    document.getElementById("auditmanagementTablePANE").style.border =  "1px solid lightgray";
