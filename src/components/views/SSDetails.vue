<template>
  <section class="content" id="ssDetailsPANE">
    <vue-element-loading :active="isLoading" spinner="line-wave" color="#000" :is-full-screen="true"/>
    <button  type="button"  id="ssrightsideModalCOMbTN"  class="btn btn-demo"  data-toggle="modal"  data-target="#ssPopUp" data-backdrop="static" data-keyboard="false" v-show="false">Right Sidebar Modal Popup</button>
    <div
        ...
        <div class="modal-content">
          <div class="modal-header" style="padding:15px;">
            <button type="button" class="close"
              data-dismiss="modal" @click="backtoparentMethod"
              aria-label="Close"
              title="close window"
            >
              <span aria-hidden="true" style="font-size: 25px">&times;</span>
            </button>
            <h4 class="modal-title" id="ssmyModalLabel2">
              <i class="fa fa-map-marker text-blue" />
              {{selectSSlocationName}} - Sub Station Details
            </h4>
          </div>
              ...
              <div class="grid">
                <div class="gc gc--1-of-3">
                  <div class="menu">
                    ...
                    <div @click="getsubstationDCUDETAILSPANEdetails">
                ...
                <div class="gc gc--2-of-3">
                  <ul class="nacc">
                    <li class="active" id="ssnameplateLI_TABPANE">
                      ...
                      >
                        <h3 style="margin-top: 5px;color: #174b79;">&nbsp;DCU Name Plate</h3>
                        ...
                        <div class="row" id="ssthirdrowID1">
                          <div class="col-lg-12">
                            ...
                            <div class="col-lg-2">
                              <h4 class="fontsize16">DCU Time</h4>
                            </div>
                            <div class="col-lg-2">
                              <h4 class="fontsize16">: {{selectDCUTIMETXT}}</h4>
                            </div>
                            <div class="col-lg-2">
                                 ...
                                 <div class="col-lg-6 text-right">
                                   <span>Choose Feeder : </span>
                                    <select
                                      ...
                                      class="inputTEXTcss" @change="chnageMidnightfeedername(feedermidnightSELTXT)"
              ...
              <div class="box-header with-border">
                <div class="text-right" style="float:right">
                  ...
                  <div class="btn-group" style="float:right" role="group">
                    ...
                    <button
                      id="ssconncurveWeekBTN"
                      type="button" @click="markerConvBTN('Week')"
                      class="btn btn-sm btn-primary active"
                    >W</button>
...
export default {
  name: 'ssDetailsPopup',
  props:['callssRandomNum','nameplateSubStationJson','selectSSPopupDucID','selectSSDcuStatus','selectSSObject'],
  components: {
    CripNotice,
    VueElementLoading,
    Datepicker
  ...
  created(){
    // console.log('SS Details popup Created');
  },
  mounted () {
    // console.log('SS Details popup mounted');
  },
  watch:{
    callssRandomNum: function(){
          this.isLoading = true;
          console.log('SS Details popup callssRandomNum');
          ...
          this.selectDCUStatusTXT = this.selectSSDcuStatus;
          document.getElementById("ssrightsideModalCOMbTN").click();
          document.getElementById("ssnameplatepaneBTN").click();
          this.getfeederlist(this.selectSSPopupDucID);
  ...
  methods: {
     ...
     getSSInfopopup(){
      ...
      console.log('substation_nameplate_summaryURL :', substation_nameplate_summaryURL);
        ...
        if (response.data.status == "found") {
          ...
          console.log('---------------calling-----3333333333333333333--------');
               } else {
    ...
    chnageEventfeedername(feedername){
      ...
      this.getsubstationEvent(this.selectSSPopupDucID,this.feederEventSELTXT,startdate,startdate);
    },
    chnageMidnightfeedername(feedername){
      this.feedermidnightSELTXT = feedername;
      var startdate = new Date();
       this.getsubstationMidnight(this.selectSSPopupDucID,this.feedermidnightSELTXT,startdate,startdate);
    },
    ...
    getsubstationloadsurveyPANEdetails(){
      ...
      this.getsubstationloadsurvey(currdate,this.selectSSPopupDucID,this.feederloadSurveySELTXT);
    ...
    getsubstationMidnightPANEdetails(){
      this.isLoading =  true;
        ...
        if(this.ssfeederlist.length != 0){
          ...
          this.chnageMidnightfeedername(this.feedermidnightSELTXT);
        }else{
           this.warningMessage('feeder name not available');
           return false;
        }
    ...
    getDCUDetailsMethod(){
      ...
      var substation_dcudetails_summaryURL = this.substation_dcudetails_summaryURL.replace("$$dcuid$$", this.selectSSPopupDucID);
    ...
    substationEventBTN(eventBtnName){
      ...
      this.getsubstationEvent(this.selectSSPopupDucID,this.feederEventSELTXT,startdate,enddate);
      ...
      this.getsubstationEvent(this.selectSSPopupDucID,this.eventselNameTXT,startdate,enddate);
    ...
    getsubstationEvent(selectSSPopupDucID,feedername,startdate,enddate){
      this.isLoading = true;
      var substation_event_summaryURL = this.substation_event_summaryURL.replace("$$dcuid$$", selectSSPopupDucID).replace("$$feedername$$", feedername).replace("$$startdate$$", this.changeYYYYDDMMFORMAT(startdate)).replace("$$enddate$$", this.changeYYYYDDMMFORMAT(enddate));
    ...
    getsubstationMidnight(selectSSPopupDucID,feedername,startdate,enddate){
      this.isLoading = true;
      var substation_midnight_summaryURL = this.substation_midnight_summaryURL.replace("$$dcuid$$", selectSSPopupDucID).replace("$$feedername$$", feedername).replace("$$startdate$$", this.changeYYYYDDMMFORMAT(startdate)).replace("$$enddate$$", this.changeYYYYDDMMFORMAT(enddate));
      axios.get(substation_midnight_summaryURL).then(response => {
        if (response.data.status == "found") {
    ...
    outageFeederBTN(outageBTNname){
      ...
      var startdate = new Date();
      startdate.setDate(startdate.getDate());
      this.getOutageDetails(this.selectSSPopupDucID,startdate,enddate);
    ...
    getOutageDetails(selectSSPopupDucID,startdate,enddate){
      this.isLoading = true;
      var substation_outage_summaryURL = this.substation_outage_summaryURL.replace("$$dcuid$$", selectSSPopupDucID).replace("$$startdate$$", this.changeYYYYDDMMFORMAT(startdate)).replace("$$enddate$$", this.changeYYYYDDMMFORMAT(enddate));
    ...
    getOverloadDetails(selectSSPopupDucID,startdate,enddate){
      this.isLoading = true;
      var substation_overload_summaryURL = this.substation_overload_summaryURL.replace("$$dcuid$$", selectSSPopupDucID).replace("$$startdate$$", this.changeYYYYDDMMFORMAT(startdate)).replace("$$enddate$$", this.changeYYYYDDMMFORMAT(enddate));
    ...
    idleFeederBTN(idleBTNname){
      ...
      var startdate = new Date();
      startdate.setDate(startdate.getDate());
      this.getIdleDetails(this.selectSSPopupDucID,startdate,enddate);
    ...
    getIdleDetails(selectSSPopupDucID,startdate,enddate){
      this.isLoading = true;
      var substation_idle_summaryURL = this.substation_idle_summaryURL.replace("$$dcuid$$", selectSSPopupDucID).replace("$$startdate$$", this.changeYYYYDDMMFORMAT(startdate)).replace("$$enddate$$", this.changeYYYYDDMMFORMAT(enddate));
    ...
    overloadfeederBTN(overloadBTNname){
      ...
      var startdate = new Date();
      startdate.setDate(startdate.getDate());
      this.getOverloadDetails(this.selectSSPopupDucID,startdate,enddate);
     ...
     substationLoadcurveBTN(loadcurveBTNname){
      ...
      var startdate = new Date();
      startdate.setDate(startdate.getDate());
      this.getLoadcurveEvent(this.selectSSPopupDucID,this.feederSELTXT,loadcurveBTNname,startdate,enddate);
    ...
    getsubstationloadsurvey(startdate,selectSSPopupDucID,feederloadSurveySELTXT){
      this.isLoading = true;
      var substation_loadsurvey_summaryURL = this.substation_loadsurvey_summaryURL.replace("$$dcuid$$", selectSSPopupDucID).replace("$$feedername$$", feederloadSurveySELTXT).replace("$$startdate$$", this.changeYYYYDDMMFORMAT(startdate));
    ...
    getsubstationLoadSurveyMethod(){
      this.submitMeterName = this.feederloadSurveySELTXT;
      this.getsubstationloadsurvey(this.loadsurveyfeedTableFromdateTXT,this.selectSSPopupDucID,this.feederloadSurveySELTXT);
    },
    pollMissingLoadSurveyDataMethod(){
      var pollMissingdataJson = {
        username:this.user_name,
        role:this.user_role,
        select_object: this.selectSSObject,
    ...
    substationCumulativecurveBTN(cumulativecurveBTNname){
      ...
      var startdate = new Date();
      startdate.setDate(startdate.getDate());
      this.getCumulativecurveEvent(this.selectSSPopupDucID,cumulativecurveBTNname,startdate,enddate);
